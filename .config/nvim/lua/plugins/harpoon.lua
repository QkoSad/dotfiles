return {
  ...
  event = "VeryLazy",
  keys = {
    { "<leader>a", function() require("harpoon"):list():add() end, desc = "Add buff to harpoon" },
    {
      "<C-e>",
    ...
    { "<C-p>", function() require("harpoon"):prev() end, desc = "Select previous item from harpoon" },
    { "<C-n>", function() require("harpoon"):next() end, desc = "Select next item from harpoon" },
  },
  config = function()
    -- REQUIRED
